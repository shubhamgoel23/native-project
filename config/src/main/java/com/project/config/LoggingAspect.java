...
import static com.project.util.HelperClass.cleanString;
...
public class LoggingAspect {
    ...
    public void beforeEntering(JoinPoint joinPoint) {
        ...
        IntStream.range(0, argName.length).forEach(i -> log.info("param_{} ([{}] : [{}]) - [{}]", i, argName[i],
                argType[i].getSimpleName(), cleanString.apply(argValue[i])));
